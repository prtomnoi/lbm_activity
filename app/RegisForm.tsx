    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 w-full">
          <p className="font-bold drop-shadow-[1px_1px_0px_#FF1658] lg:drop-shadow-[3px_3px_0px_#FF1658] text-[22px] lg:text-[40px] text-primary-1 leading-none">
            Email:
          </p>
          <input
            type="email"
        ...
        <button
          type="submit"
          className="bg-primary-1 rounded-full p-1 w-fit drop-shadow-[4px_3px_0px_#FF1658] text-[17px] font-bold text-white"
        >
